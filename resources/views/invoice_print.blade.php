    ...
    {
      if($_SERVER['QUERY_STRING'] == 'show=all')
      $printCount = 3;
    }


    for($x = 1; $x <= $printCount; $x++) { ?>
            ...
            <td style="padding:8px;width:100%;border:none;">
              <table cellspacing="0" cellpadding="0" border="0" style="margin-bottom:15px;width:100%;">
                <tr>
                  ...
                  <td valign="middle" align="center" class="nobdr" style="width:15%;font-size:15px;"><?php echo  ($x==1)?'Original for Recipient':(($x==2)?'Duplicate for Supplier':'Triplicate for Accounts') ?></td>
                </tr>
              </table>  
              <table cellspacing="0" cellpadding="0" style="width: 100%; margin-bottom:5px; border-collapse:separate;">
                <tr>
