...
<body>
    ...
    <section class="pt-1 pb-4 job-form" id="job-form">
        ...
        @if(isset($result) &&  isset($result['id']) && $result['id'] !='')
        <form action="{{ $result['action'] }}" method="post" name="paymentProceedForm" id="paymentProceedForm" onSubmit="return validateProceedPayment();">
          @csrf  
            ...
            <div class="col-sm-12 col-md-12 col-lg-11 col-xl-10 pb-4">
              ...
              <!-- For Step 1 Start-->
                <div class="col-sm-7 col-md-8 pr-xl-5 pl-md-5 pl-lg-3 order-2 order-sm-1" id="step-plan" data-title="Select Your Service Type">
                  <div class="row service-type-box mx-0 mr-lg-3 mb-4 select-box" data-value="Standard" id="plan_standard" style="display: none;">
                    ...
                    <div class="col-10 p-3 pl-xl-4">
                      ...
                      <ul class="bullet bullet-black">
                        ...
                        <li>Estimated data recovery time upto <span class="recovery-time">10 days</span></li>
                        <li><span class="support-via">Support via email and phone </span></li>
                        <li>Job update twice in a week</li>
                        <li>No account manager assigned</li>
                        <li><span class="speed-lab">High speed lab computers used for data recovery </span></li>
                        <li>No Recovery - No Charge* policy applicable</li>
                        <li>Data confidentiality confirmation via Email</li>
                      </ul>
                    </div>
                  </div>
                  <div class="row service-type-box mx-0 mr-lg-3 mb-4 select-box" data-value="Economy" id="plan_economy" style="display: none;">
                    ...
                    <div class="col-10 p-3 pl-xl-4">
                      ...
                      <ul class="bullet bullet-black">
                        <li>Budget friendly data recovery service</li>
                        <li>Estimated data recovery time upto <span class="recovery-time">20 days</span> </li>
                        <li><span class="support-via">Support via email only </span></li>
                        <li>Job Update on job completion</li>
                        <li>No account manager assigned</li>
                        <li><span class="speed-lab">Regular speed lab computers used for data recovery </span></li>
                        <li>No Recovery - No Charge* policy not applicable</li>
                        <li>Data confidentiality confirmation via Email</li>
                      </ul>
                    </div>
                  </div>
                  <div class="row service-type-box mx-0 mr-lg-3 mb-4 select-box" data-value="Priority" id="plan_express" style="display: none;">
                    ...
                    <div class="col-10 p-3 pl-xl-4">
                      ...
                      <ul class="bullet bullet-black">
                        <li>Express  data recovery service charges</li>
                        <li>Estimated data recovery time upto <span class="recovery-time">5 days</span> </li>
                        <li><span class="support-via">Support via email and phone</span></li>
                        <li>Job Update on daily basis</li>
                        <li>Dedicated account manager assigned</li>
                        <li><span class="speed-lab">Very high speed lab computers used for data recovery </span></li>
                        <li>No Recovery - No Charge* policy applicable</li>
                        <li>Data confidentiality confirmation via Data Wiping Certificate</li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col-sm-7 col-md-8 mb-3 order-2 order-sm-1" id="step-info" data-title="Verify Your Details" style="display:none">
                    ...
                    <div class="card-body pr-xl-2">
                        ...
                        <tbody>
                          ...
                          <input type="hidden" name="payment_channel" id="payment_channel" value="Online">
                          ...
                          <input type="hidden" name="tax_applicable" id="tax_applicable" value="" />
                        ...
                        @if($errors->any())
                            <div class="alert alert-danger py-2 fs14" style="max-width: 500px;">
                        ...
                        @endif
                        <div class="alert alert-danger details-alert py-2 fs14" style="display:none; max-width:500px;"></div>
                        <button type="submit" class="btn btn-primary pl-md-5 pr-md-5 pl-4 pr-4 mt-1 mb-2 fs16"  name="proceed_pay" value="proceed">Proceed To Pay <i class="bi bi-arrow-right"></i></button>
...
<script defer src="{{ url('public/js/payment.js?v=3') }}"></script>
<script>
  $(function(){
    var loadscript=new load_script();
    loadscript.countNumber();
    QuotePrice("<?php echo !empty($result['id']) ? $result['id'] : '' ?>");
    <?php if($errors->any()){ ?>
