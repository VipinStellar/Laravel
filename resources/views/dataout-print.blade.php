...
<div id="parent">
  <h1 style="margin-top: 0px;"><u>Data Out</u></h1>
  <div class="divRow">
    <div class="divCell1">
  ...
  <div class="divRow">
    <div class="divCell">
     ...
     <p>
        ...
        Signature on this receipt acknowledges that you have received Data from Stellar Information Technology Private Ltd. Please sign and date the data out receipt.
     </p>
     <p>
     <strong><u>Stellar Certification</u></strong><br>
      I, <strong>{{ $result->ContactData['name'] }}</strong>, certify that I have received the Data from Stellar Information Technology Private Ltd.
      <br>I further understand that by signing this statement as required, I am indicating that I have reviewed the
      data and found it upto my satisfaction. I will not ask for rework. 
      <br>
    ...
    <p>
      ...
      <strong>*</strong> Share your grievences at complaints@stellarinfo.com to help us serve you better. <br>
    ...
    <table class="table" width="100%" style="padding-top:5px;">
        <tbody>
          <tr>
            <td align="left" width="33%">Doc. No : SITPL/IMS/DB(OP)/FM-13</td>
