...
class JobController extends Controller
{
    ...
    public function joblist(Request $request)
    {
        ...
        $branchId = implode(',',$this->_getBranchId());
        $select = 'transfer_media.media_id as transfer_media_id,transfer_media.media_in_date as media_in_date,transfer_media.assets_type,transfer_media.id as transferId,transfer_media.gatepass_status as getpasStatus,gatepass_id.gatepass_id as getpassId,
