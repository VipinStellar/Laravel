...
class MediaController extends Controller
{
    ...
    function updateMediaAssessment(Request $request)
    {
        ...
        $media->tampering_required = ($media->tampered_status == 'Tampered Media')?'Already Tampered':$request->input('tampering_required');
        ...
        $media->drive_count = $request->input('drive_count');
        $media->media_condition = $request->input('media_condition');
        $media->media_ubi = $request->input('media_ubi');
        $media->backup_software = $request->input('backup_software');
        $media->cloning_possibility = $request->input('cloning_possibility');
