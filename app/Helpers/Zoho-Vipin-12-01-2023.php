...
class Zoho 
{
   ...
   public  function logApiCall($log_data = array()){
    ...
    public function dataFormateInspection($params = array())
            ...
            $zoho_crm_data = array(
				"data" => array(
				  array(
                    ...
                    "Invoice_Link" =>url('view-invoice')."/".$params->ServiceInvoice->id."/".$params->ServiceInvoice->request_id,
        ...
        {
            $objDateTime = new DateTime($params->created_on);
            $zoho_crm_data = array(
				"data" => array(
				  array(
                    ...
                    "Status" => 'success',
                    "Invoice_Status" => 'Invoice Generated',
                    "Invoice_Link" =>url('view-invoice')."/".$params->id."/".$params->request_id,
